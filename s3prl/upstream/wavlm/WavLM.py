...
class WavLM(nn.Module):
    ...
    def extract_features(
        ...
        x, layer_results, fc_results = self.encoder(
            x,
        ...
        return feature, res["padding_mask"], fc_results
...
class TransformerEncoder(nn.Module):
    ...
    def forward(self, x, padding_mask=None, streaming_mask=None, layer=None):
        x, layer_results, fc_results = self.extract_features(x, padding_mask, streaming_mask, layer)
...
class TransformerSentenceEncoderLayer(nn.Module):
    ...
    def forward(
        ...
        return x, attn, pos_bias, fc1, fc2
